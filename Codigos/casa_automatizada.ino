...
int limite_gas = 300;     //definine valor máximo de gás (nível de gás normal)
int limite_luz = 700;     //define luminosidade limite para acender a luz do jardim
float limite_temp = 19;   //define temperatura limite para acionar ventilador
...
void controle_portao (bool portao)
{
  ...
  /*Fecha o portão*/
  else if (portao == false)
  {
    /*Varia o ângulo do motor de 140 a 10*/
    for (pos = 140; pos >= 10; pos--)
      s.write(pos);
  }
